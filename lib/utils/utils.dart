...
class LanguagePickerUtils {
  static Language getLanguageByIsoCode(String isoCode, List<Map<String,String>>languagesList) {
    final _languages = languagesList.map((item) => Language.fromMap(item)).toList();
    try {
      return _languages
          .where((language) =>
